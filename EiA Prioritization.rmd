...
numericInput(inputId="H1_Thresh", 
               label=hazards[1], 
               value=haz_class[index_name==gsub("_max","",hazards[1]) & description=="Moderate",lower_lim],
               min=0,
               max=100,
               step=1,
               width="100px")
...
numericInput(inputId="H2_Thresh", 
               label=hazards[2], 
               value=haz_class[index_name==gsub("_max","",hazards[2]) & description=="Moderate",lower_lim],
               min=0,
               max=100,
               step=1,
               width="100px")
...
numericInput(inputId="H3_Thresh", 
               label=hazards[3], 
               value=haz_class[index_name==gsub("_max","",hazards[3]) & description=="Moderate",lower_lim],
               min=0,
               max=100,
               step=1,
               width="100px")
...
numericInput(inputId="H4_Thresh", 
               label=hazards[4], 
               value=haz_class[index_name==gsub("_max","",hazards[4]) & description=="Moderate",lower_lim],
               min=0,
               max=100,
               step=1,
               width="100px")
...
numericInput(inputId="H5_Thresh", 
               label=hazards[5], 
               value=haz_class[index_name==gsub("_max","",hazards[5]) & description=="Moderate",lower_lim],
               min=0,
               max=100,
               step=1,
               width="100px")
...
numericInput(inputId="H6_Thresh", 
               label=hazards[6], 
               value=haz_class[index_name==gsub("_max","",hazards[6]) & description=="Moderate",lower_lim],
               min=0,
               max=100,
               step=1,
               width="100px")
...
numericInput(inputId="H7_Thresh", 
               label=hazards[7], 
               value=haz_class[index_name==gsub("_max","",hazards[7]) & description=="Moderate",lower_lim],
               min=0,
               max=100,
               step=1,
               width="100px")
...
numericInput(inputId="H8_Thresh", 
               label=hazards[8], 
               value=haz_class[index_name==gsub("_max","",hazards[8]) & description=="Moderate",lower_lim],
               min=0,
               max=100,
               step=1,
               width="100px")
...
HazardWrapper<-function(Thresholds,FileName,SaveDir,PropThreshold,PropTDir,hazard_dir,Scenarios){
  ...
  Hazards<-lapply(1:nrow(Scenarios),FUN=function(j){
      save_file<-paste0(SaveDir,"/Haz-",Scenarios$Scenario[j],"-",Scenarios$Time[j],"-",FileName,".tif")
      THRESH<-Thresholds
    ...
    for(i in 1:nrow(THRESH)){
      ...
      Data<-terra::rast(Files[grepl(Scenarios$Scenario[j],Files) & grepl(Scenarios$Time[j],Files) & grepl(THRESH$Variable[i],Files)])
    ...
    terra::writeRaster(Hazards,filename=save_file,overwrite=T)
    Hazards
        }else{
          terra::rast(save_file)
        }
  })
